...
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `avatar`, `role`, `created_at`) VALUES (1, 'Nguyen Van A', 'user1@example.com', '$2a$10$jKNZysizWR5AMYF4iubYcurDkEg2d5wj5M77xkGbco5GUmy/RISL2', NULL, 'USER', '2025-01-01 10:00:00');
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `avatar`, `role`, `created_at`) VALUES (2, 'Tran Thi B', 'user2@example.com', '$2a$10$jKNZysizWR5AMYF4iubYcurDkEg2d5wj5M77xkGbco5GUmy/RISL2', NULL, 'USER', '2025-01-02 11:00:00');
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `avatar`, `role`, `created_at`) VALUES (3, 'Le Van C', 'user3@example.com', '$2a$10$jKNZysizWR5AMYF4iubYcurDkEg2d5wj5M77xkGbco5GUmy/RISL2', NULL, 'USER', '2025-01-03 12:00:00');
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `avatar`, `role`, `created_at`) VALUES (4, 'Pham Thi D', 'user4@example.com', '$2a$10$jKNZysizWR5AMYF4iubYcurDkEg2d5wj5M77xkGbco5GUmy/RISL2', NULL, 'USER', '2025-01-04 13:00:00');
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `avatar`, `role`, `created_at`) VALUES (5, 'Lê Văn An', 'admin@example.com', '$2a$10$jKNZysizWR5AMYF4iubYcurDkEg2d5wj5M77xkGbco5GUmy/RISL2', NULL, 'ADMIN', '2025-01-05 14:00:00');
